...
class MLP(object):
    ...
    def _add_layer_with_loss_1(self, input, inshape, outshape, stddev, keep_prob, wl, name, a0,
                             transfer_function=tf.nn.relu, factor=1, isdimgeneral=False, is_BN=False, islstlayer=False):
    ...
    def getallparas(self):
        ...
        # for j in range(len(self.layernum_2) - 1):
        #     allparas.append(self.weights['w_L_layer' + str(j + 1)])
        #     allparas.append(self.weights['b_L_layer' + str(j + 1)])
